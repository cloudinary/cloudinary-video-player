...
class ContextMenuPlugin {
  ...
  static isInvalidOpts(Opts) {
    return !Array.isArray(Opts.content) && typeof Opts.content !== 'function';
  }

  constructor(player, intOpts) {
    if (ContextMenuPlugin.isInvalidOpts(intOpts)) {
      throw new Error('"content" required');
    }

    const opts = assign({}, defaults, intOpts);
  ...
  onContextMenu(e) {
    ...
    const { left, top } = this.getMenuPosition(e);
